...
public class CustomAdapterGrid extends BaseAdapter {
    ...
    CustomAdapterGrid(Context contextGrid,ArrayList<QuotesCatagoryModel> quotesCatagoryModelArrayList,int[] images){
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        holder.tvGridView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentGrid=new Intent(contextGrid,ListActivity.class);
